...
// https://icons.getbootstrap.com/icons/clipboard-x-fill/
export function ClipboardXIcon(props: IProps): React.JSX.Element {
    const { width = 16, height = 16, fill = 'currentColor' } = props;
